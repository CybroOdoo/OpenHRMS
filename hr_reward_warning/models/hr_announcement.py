...
class HrAnnouncement(models.Model):
    ...
    def _compute_has_acknowledged(self):
        """Compute whether the current logged-in user's employee has
        acknowledged this announcement."""
        for record in self:
    ...
    def action_acknowledge(self):
        """Record the acknowledgment of the announcement by the current
        logged-in employee."""
        self.ensure_one()
    ...
    def get_active_announcements(self):
        """Retrieve active and unacknowledged announcements targeted at
