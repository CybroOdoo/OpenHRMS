...
class ResConfigSettings(models.TransientModel):
    ...
    schedule_attendance_downloads = fields.Boolean(string="Schedule Downloads",
               config_parameter='oh_hr_zk_attendance.schedule_downloads',
                                                   default=False,
    ...
    schedule_time_interval = fields.Integer(string="Schedule Time Interval",
            config_parameter='oh_hr_zk_attendance.schedule_time_interval',
                                            default=1,
    ...
    schedule_time_period = fields.Selection(
        ...
        config_parameter='oh_hr_zk_attendance.schedule_time_period',
